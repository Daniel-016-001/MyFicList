        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="break-inside-avoid mb-6">
                                <div class="bg-slate-900 rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-[1.02] border border-blue-900/20 flex flex-col">
                                    ...
                                    <div class="p-5 flex-grow flex flex-col">
                                        <h4 class="font-bold text-lg text-white leading-tight mb-4">{{ $media->title }}</h4>
                        ...
                        @foreach($popularByCategory['book'] as $media)
                            <div class="break-inside-avoid mb-6">
                                <div class="bg-slate-900 rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-[1.02] border border-blue-900/20 flex flex-col">
                                    ...
                                    <div class="p-5 flex-grow flex flex-col">
                                        <h4 class="font-bold text-lg text-white leading-tight mb-4">{{ $media->title }} @if($media->average_score !== 'N/A') ({{ $media->average_score }}) @endif</h4>
                                        <div class="mt-auto flex items-center justify-between pt-4 border-t border-slate-800/50">
                                            <button class="text-blue-400 hover:text-blue-300 flex items-center gap-1.5 text-xs font-bold transition-colors">
                                                <i class="fas fa-plus-circle"></i> Agregar
                                            </button>
                                            <a href="{{ route('media.show', $media->id) }}" class="text-gray-400 hover:text-white flex items-center gap-1.5 text-xs font-bold transition-colors">
                                                Detalles <i class="fas fa-arrow-right"></i>
            ...
            @if(empty($popularByCategory) || collect($popularByCategory)->flatten()->isEmpty())
                <div class="text-center py-20">
                    ...
                    <a href="{{ route('media.explore') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2 rounded-lg">Explorar Catálogo</a>
                </div>
            @endif
        </div>
    </main>
        ...
        <div class="glass max-w-md w-full p-10 rounded-3xl">
            ...
            <form action="{{ route('user-list.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="media_list_id" id="media-list-select" class="w-full bg-gray-800 border-none rounded-xl p-4 text-white font-bold focus:ring-2 focus:ring-purple-600">
                ...
                <div id="new-list-fields" class="hidden space-y-4">
                    <div>
                        <label class="block text-xs font-black text-gray-500 uppercase tracking-widest mb-3">Nombre de la lista</label>
                        <input type="text" name="new_list_name" class="w-full bg-gray-800 border-none rounded-xl p-4 text-white font-bold focus:ring-2 focus:ring-purple-600" placeholder="Ej: Favoritos, Ver más tarde...">
                    </div>
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="is_public" id="is-public" class="w-4 h-4 text-purple-600 bg-gray-800 border-gray-600 rounded focus:ring-purple-600">
                        <label for="is-public" class="text-sm font-bold text-gray-300">Lista pública (visible para otros usuarios)</label>
                    </div>
                </div>
                <div>
